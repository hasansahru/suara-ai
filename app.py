        ...
        if prov_config:
            with st.container(border=True):
                ...
                if model_id_options or allow_custom:
                    # Jika model tersimpan sebelumnya (mis. dari .env / sesi lama) sudah
                    # bukan bagian dari daftar resmi, tambahkan sebagai opsi agar tidak
                    # hilang begitu saja dari tampilan.
