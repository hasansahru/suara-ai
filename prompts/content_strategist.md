...
8. **CTA (Call To Action)** — satu CTA penutup yang sesuai dengan gaya dan larangan DNA channel (lihat instruksi channel untuk nada CTA yang diperbolehkan).
...
- Untuk **Video Panjang**: outline harus memiliki bagian Intro, minimal 2–4 segmen isi (dengan sub-poin), dan Outro/CTA, proporsional dengan durasi target. **WAJIB** sertakan `start_estimate` dan `end_estimate` (mm:ss, kumulatif dari 00:00 di VIDEO BARU) untuk setiap babak, sehingga total durasi seluruh babak menjumlah ke Durasi Target yang dipilih pengguna — ini agar editor tahu pasti "bagian mana ada di menit berapa" pada video baru.
